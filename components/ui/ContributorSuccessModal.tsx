...
interface ContributorSuccessModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function ContributorSuccessModal({ isOpen, onClose }: ContributorSuccessModalProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-gradient-to-br from-gray-900/60 via-gray-800/50 to-gray-900/60 backdrop-blur-md flex items-center justify-center z-50 p-4 overflow-y-auto"
        ...
        >
          ...
          <motion.div
            ...
            className="w-full max-w-[672px] relative my-auto"
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-600 text-sm leading-5">
                        Anda akan bisa akses dashboard dan muncul menu dashboard di dropdown profil setelah akun Anda disetujui dan diaktifkan. Mohon cek secara berkala.
                      </p>
                    </div>
                  </motion.div>
                </motion.div>
