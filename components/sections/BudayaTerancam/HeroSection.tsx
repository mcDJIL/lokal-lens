      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 py-8 sm:py-12 lg:py-16">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
          ...
          <motion.a
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-primary-gold bg-[#D49B16] hover:bg-[#C08A14] transition-all duration-300 shadow-sm hover:shadow-md whitespace-nowrap"
          >
